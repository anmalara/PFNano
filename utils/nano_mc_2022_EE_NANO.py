...
process.source = cms.Source(
    "PoolSource",
    fileNames=cms.untracked.vstring("file:nano_mc_2022_EE_PAT.root"),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation=cms.untracked.string("nano_mc_2022_EE nevts:-1"),
...
process.NANOAODSIMoutput = cms.OutputModule(
    ...
    fileName=cms.untracked.string("nano_mc_2022_EE_NanoAOD.root"),
