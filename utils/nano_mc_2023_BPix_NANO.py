...
process.source = cms.Source(
    "PoolSource",
    fileNames=cms.untracked.vstring("file:nano_mc_2023_BPix_PAT.root"),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation=cms.untracked.string("nano_mc_2023_BPix nevts:-1"),
...
process.NANOAODSIMoutput = cms.OutputModule(
    ...
    fileName=cms.untracked.string("nano_mc_2023_BPix_NanoAOD.root"),
...
from PhysicsTools.PFNano.puppiJetMETReclustering_cff import nanoPuppiReclusterCustomize_MC

# call to customisation function nanoPuppiReclusterCustomize_MC imported from PhysicsTools.PFNano.puppiJetMETReclustering_cff
