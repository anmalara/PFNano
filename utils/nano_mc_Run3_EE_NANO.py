...
process.source = cms.Source(
    "PoolSource",
    fileNames=cms.untracked.vstring("file:nano_mc_Run3_EE_PAT.root"),
...
process.NANOAODSIMoutput = cms.OutputModule(
    ...
    fileName=cms.untracked.string("nano_mc_Run3_EE_NANO.root"),
