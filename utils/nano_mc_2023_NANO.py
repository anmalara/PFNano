...
process.source = cms.Source(
    "PoolSource",
    fileNames=cms.untracked.vstring("file:nano_mc_2023_PAT.root"),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation=cms.untracked.string("nano_mc_2023 nevts:-1"),
