...
process.source = cms.Source(
    "PoolSource",
    fileNames=cms.untracked.vstring("file:nano_data_2023_CD_PAT.root"),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation=cms.untracked.string("nano_data_2023_CD nevts:-1"),
...
process.NANOAODoutput = cms.OutputModule(
    ...
    fileName=cms.untracked.string("nano_data_2023_CD_NanoAOD.root"),
